$(document).ready(function() {
    ...
    function lightbox_navigation(){ // FONCTION POUR LA NAVIGATION ENTRE LES PHOTOS
    ...
    $(document).on('click', '.fa-expand', function(){ // RECUPERE LE SRC, LE TITRE, LA RÉFÉRENCE ET LA CATÉGORIE DE L'IMAGE 
